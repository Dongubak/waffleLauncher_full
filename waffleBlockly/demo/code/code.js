...
Code.createWebHandler = function() {
...
// function sendRequest(header, sendData){
//   var xhr = new XMLHttpRequest();
//   xhr.open('POST', 'http://localhost:8080', true)
//   xhr.send(header+sendData);
// };
...
// // html to js
// var saveAlgo = document.getElementById('saveAlgorithm');
// var importBlocks = document.getElementById('importBlocks');
// var exportBlocks = document.getElementById('exportBlocks');
// var initBlocks = document.getElementById('initBlocks');
// var savePy = document.getElementById('savePy')

// // 버튼 클릭 이벤트
// saveAlgo.onclick = function(){
//   var algorithmWithPy = Blockly.Python.workspaceToCode(Code.workspace);
//   sendRequest('pypy', algorithmWithPy)
//   alert('알고리즘 저장이 완료되었습니다.')
// };

// exportBlocks.onclick = function(){
//   var xml = Blockly.Xml.workspaceToDom(Code.workspace);
//   var xml_text = Blockly.Xml.domToText(xml); 
//   sendRequest('save', xml_text)
//   alert('블록 저장이 완료되었습니다.');
// };

// importBlocks.onclick = function(){
//   getResponse('load')
//   alert('불러오기에 성공했습니다.');
// };


// initBlocks.onclick = function(){
//   getResponse('init')
//   alert('초기화에 성공했습니다.');
// };


// savePy.onclick = function(){
//   var xml = Blockly.Xml.workspaceToDom(Code.workspace);
//   var xml_text = Blockly.Xml.domToText(xml);
//   var blob = new Blob([xml_text], {type: "text/plain;charset=utf-8"});
//   saveAs(blob, "docBlocks.txt");
// };
